...
namespace Veri_Tabanli_Parti_Secim_Grafik_Istatistik
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=LAPTOP-9FJ93HJA\\SQLEXPRESS;Initial Catalog=DBSECIMPROJE;Integrated Security=True");
        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            // İlçe Adlarını ComboBoxa çekme.
            baglanti.Open();
            SqlCommand komut = new SqlCommand("SELECT ILCEADI from TBLILCE", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("SELECT * FROM TBLILCE WHERE ILCEADI=@p1", baglanti);
